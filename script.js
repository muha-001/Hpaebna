...
const menuItems = [
    ...
    { id: 1, category: 'eastern', name: 'منسف حبايبنا', price: '25,000', img: 'assets/mansaf.png', desc: 'المنسف الأصلي بالجميد واللحم البلدي', ingredients: [{ n: 'لحم خروف', i: '🍖' }, { n: 'جميد', i: '🥛' }, { n: 'أرز', i: '🍚' }, { n: 'لوز', i: '🥜' }] },
    { id: 2, category: 'eastern', name: 'كباب عراقي', price: '18,000', img: 'assets/kebab.png', desc: 'كباب مشوي على الفحم مع الطماطم والبصل', ingredients: [{ n: 'لحم مفروم', i: '🥩' }, { n: 'بصل', i: '🧅' }, { n: 'سماق', i: '🧂' }, { n: 'خبز', i: '🫓' }] },
    { id: 3, category: 'eastern', name: 'قوزي على تمن', price: '30,000', img: 'assets/quzi.png', desc: 'قطعة لحم كتف مطهية ببطء مع الرز والمكسرات', ingredients: [{ n: 'لحم كتف', i: '🍖' }, { n: 'أرز مبهر', i: '🍚' }, { n: 'زبيب', i: '🍇' }, { n: 'مكسرات', i: '🥜' }] },
    { id: 4, category: 'eastern', name: 'دولمة عراقية', price: '15,000', img: 'assets/dolma.png', desc: 'مشكل خضار محشي بالرز واللحم المفروم', ingredients: [{ n: 'ورق عنب', i: '🍃' }, { n: 'بصل', i: '🧅' }, { n: 'لحم', i: '🥩' }, { n: 'أرز', i: '🍚' }] },
    { id: 5, category: 'eastern', name: 'سمك مسكوف', price: '35,000', img: 'assets/masgouf.png', desc: 'السمك العراقي الشهير المشوي بالطريقة التقليدية', ingredients: [{ n: 'سمك', i: '🐟' }, { n: 'ليمون', i: '🍋' }, { n: 'ملح خشن', i: '🧂' }, { n: 'نار الحطب', i: '🔥' }] },
